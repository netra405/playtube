...
const Profile = () => {
    ...
    const handleSignout = async () => {
        try {
            ...
            console.log(error);
            showCustomAlert(`Sign Out error: ${error}`);
        }
        ...
        <div>
            <div className='absolute right-5 top-10 mt-2 w-72 bg-[#212121] text-white rounded-xl shadow-lg z-50 hidden md:block'>
                ...
                <div className='flex flex-col py-2'>
                    ...
                    <button onClick={() => navigate("/signup")} className='flex items-center gap-3 px-4 py-2 hover:bg-gray-700'><TiUserAddOutline className='text-xl' />Create new Account</button>
                    <button onClick={() => navigate("/signin")} className='flex items-center gap-3 px-4 py-2 hover:bg-gray-700'><MdOutlineSwitchAccount className='text-xl' />Sign In with other Account</button>
                    ...
                    {userData && <button onClick={handleSignout} className='flex items-center gap-3 px-4 py-2 hover:bg-gray-700'><FiLogOut className='text-xl' />Sign Out</button>}
