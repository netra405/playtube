...
//       const payload = {
//         userName: user.displayName || "Google User", // fallback
//         email: user.email,
//         photoUrl: user.photoURL || "",
//       };
...
//                 : "/default-avatar.png" // fallback if no photoUrl
//             }
...
//         {/* Show sign out and PT Studio if logged in */}
//         {userData && (
//           <>
//             {userData?.channel && (
//               <button className="flex items-center gap-3 px-4 py-2 hover:bg-gray-700 mt-2">
      ...
      {userData && (
        <div className="flex items-start gap-3 p-4 border-b border-gray-700">
          <img
            src={
              channelData?.avatar
                ? channelData.avatar.startsWith("http")
                  ? channelData.avatar
                  : `${serverUrl}${channelData.avatar}`
                : userData?.photoUrl
                ? userData.photoUrl.startsWith("http")
                  ? userData.photoUrl
                  : `${serverUrl}${userData.photoUrl}`
