            ...
            <div className="flex flex-col items-center mt-16 sm:mt-20 text-center">
                ...
                {!selected ? (
                    ...
                    <>
                        ...
                        <button onClick={handleRoute} className="bg-white mb-15 text-black mt-4 px-6 py-2 rounded-full font-medium hover:bg-gray-200 transition">
                            + Create
                        </button>
                    </>
                )}
...
//     const options = [
//         { id: "video", icon: <RiVideoUploadLine size={28} />, title: "Upload Video" },
...
//     return (
//         <div className="bg-[#0f0f0f] min-h-screen text-white px-4 sm:px-6 lg:px-12 py-8 flex flex-col">
//             {/* Header */}
//             <header className="mb-12 border-b border-[#3f3f3f] pb-4 text-center sm:text-left">
//                 <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Create</h1>
//                 <p className="text-gray-400 mt-2 text-sm sm:text-base">
...
//                         <button
//                             onClick={handleRoute}
//                             className="bg-white mb-15 text-black mt-4 px-6 py-2 rounded-full font-medium hover:bg-gray-200 transition"
//                         >
//                             + Create
//                         </button>
//                     </>
